...
=======
    ...
    public int toBlackAndWhite(int blackLimit){
        int intensity = (this.getR() + this.getB() + this.getG())/3;
        int newShade;
        if(intensity < blackLimit) newShade = 1;
        else newShade = 0;
        return newShade;
    }
>>>>>>> Implement calculation of nonograms and drawing of simple grid
}
